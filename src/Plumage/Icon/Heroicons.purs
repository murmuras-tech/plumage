...
badgeCircle = outline "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" ∷ JSX
ban =
  outline
...
bookmark = outline "M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" ∷ JSX
bookmarkAlt =
  outline
...
check = outline "M5 13l4 4L19 7" ∷ JSX
checkCircle = outline "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" ∷ JSX
chevronDown = outline "M19 9l-7 7-7-7" ∷ JSX
chevronLeft = outline "M15 19l-7-7 7-7" ∷ JSX
triangleLeft = outline "M15 19l-7-7 7-7Z" ∷ JSX
chevronRight = outline "M9 5l7 7-7 7" ∷ JSX
triangleRight = outline "M9 5l7 7-7 7Z" ∷ JSX
...
clock = outline "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" ∷ JSX
cloud =
  outline
...
code = outline "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" ∷ JSX
cog =
  outlines
...
dotsCircleHorizontal =
  outline "M8 12h.01M12 12h.01M16 12h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" ∷
    JSX
...
download =
  outline "M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" ∷ JSX
...
hashtag = outline "M7 20l4-16m2 16l4-16M6 9h14M4 15h14" ∷ JSX
heart =
  outline
...
informationCircle =
  outline "M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" ∷ JSX
...
library =
  outline "M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z" ∷
    JSX
...
lightningBolt = outline "M13 10V3L4 14h7v7l9-11h-7z" ∷ JSX
link =
  outline
...
menuAlt1 = outline "M4 6h16M4 12h8m-8 6h16" ∷ JSX
menuAlt2 = outline "M4 6h16M4 12h16M4 18h7" ∷ JSX
menuAlt3 = outline "M4 6h16M4 12h16m-7 6h7" ∷ JSX
menuAlt4 = outline "M4 8h16M4 16h16" ∷ JSX
...
minusCircle = outline "M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" ∷ JSX
minusSm = outline "M18 12H6" ∷ JSX
minus = outline "M20 12H4" ∷ JSX
moon =
  outline
...
paperAirplane = outline "M12 19l9 2-9-18-9 18 9-2zm0 0v-8" ∷ JSX
paperClip =
  outline
    "M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" ∷
    JSX

pause = outline "M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z" ∷ JSX
pencilAlt =
  outline
...
plusCircle =
  outline "M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" ∷ JSX

plusSm = outline "M12 6v6m0 0v6m0-6h6m-6 0H6" ∷ JSX
plus = outline "M12 4v16m8-8H4" ∷ JSX
...
reply = outline "M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6" ∷ JSX
rewind =
  outline
...
search = outline "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" ∷ JSX
selector = outline "M8 9l4-4 4 4m0 6l-4 4-4-4" ∷ JSX
server =
  outline
...
sortAscending = outline "M3 4h13M3 8h9m-9 4h6m4 0l4-4m0 0l4 4m-4-4v12" ∷ JSX
sortDescending = outline "M3 4h13M3 8h9m-9 4h9m5-4v12m0 0l-4-4m4 4l4-4" ∷ JSX
sparkles =
  outline
...
switchHorizontal =
  outline "M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" ∷ JSX

switchVertical =
  outline "M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4" ∷ JSX
...
trendingDown = outline "M13 17h8m0 0V9m0 8l-8-8-4 4-6-6" ∷ JSX
trendingUp = outline "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" ∷ JSX
truck =
  outlines
...
upload =
  outline "M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" ∷ JSX
...
viewList = outline "M4 6h16M4 10h16M4 14h16M4 18h16" ∷ JSX
volumeOff =
  outlines
